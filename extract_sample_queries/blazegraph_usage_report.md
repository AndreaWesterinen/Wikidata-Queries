...
| --- | --- | ---: |
| Blazegraph Features | Named sub-queries (`WITH { ... } AS %name`, `INCLUDE %name`) | 18 |
...
| SERVICE Extensions | `SERVICE wikibase:around` | 6 |
| SERVICE Extensions | `SERVICE wikibase:box` | 1 |
| SERVICE Extensions | `SERVICE wikibase:label` | 416 |
...
| Supporting Blazegraph-Specific Syntax | `bd:serviceParam` | 423 |
...
- Total matches across this section: 437
...
Matching files:
- Over 400 matching files (not listed individually)
...
- Total matches across this section: 443
